    ...
    return (
      <html>
        <head>
          ...
          {assets && assets.styles && assets.styles.app && <link href={assets.styles.app} rel="stylesheet" charSet="UTF-8"/>}
        ...
        <body>
          ...
          {assets && assets.javascript && assets.javascript.app && <script src={assets.javascript.app} charSet="UTF-8"></script>}
        </body>
      </html>
    );
  }
